...
on s.student_id=e.student_id and enrollment_id is not NULL; 
...
select s.student_name ,count(e.enrollment_id) from students as s inner join enrollments as e 
on s.student_id=e.student_id group by student_name ; 


-- count credit of each student  
...
from students as s left join enrollments as e
 ...
 on s.student_id group by char_length(s.student_name);
